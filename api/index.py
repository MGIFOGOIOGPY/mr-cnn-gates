...
def find_ecommerce_stores():
    ...
    try:
        ...
        ecommerce_queries = [
            # Added dorks for better search results
            'inurl:"add-payment-method" intext:"Card Number" intext:"CVV" intext:"Expiration Date"',
            'inurl:"add-payment-method" intext:"Pay with card"',
            'inurl:"add-payment-method" intext:"Card Number" "Expiration Date (MM/YY)"',
            'intext:"add-payment-method" "Card Number" "CVV"',
            'intitle:"add-payment-method" "Card Number"',
            'allintext:"add-payment-method" "Card Number" "CVV"',
            ...
            '"intext:\"Pay with card\" \"Card Number\" \"Expiration Date (MM/YY)\" \"CVV\""',
            ...
            '"intext:\"Pay with card\" \"Card Number\" \"Expiration Date\" \"CVV\" \"Braintree\""',
